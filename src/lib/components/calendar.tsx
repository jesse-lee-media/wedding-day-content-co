...
const Calendar = ({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) => (
  <DayPicker
    ...
    classNames={{
      ...
      nav_button:
        'size-7 inline-flex items-center rounded-md hover:bg-black/5 justify-center bg-transparent p-0 transition opacity-50 hover:opacity-100 focus:opacity-100',
      ...
      day: 'size-9 p-0 font-medium aria-selected:opacity-100 hover:[&:not(.day-range-start,.day-range-end,.day-range-middle)]:rounded-md hover:[&:not(.day-range-start,.day-range-end,.day-range-middle)]:bg-black/5',
      day_range_start: 'day-range-start rounded-l-md',
      day_range_end: 'day-range-end rounded-r-md',
      day_selected: 'day-selected bg-black text-white hover:!opacity-75',
      day_today: 'bg-pink-50 rounded-md text-black/75 !opacity-100 pointer-events-none',
      day_outside:
