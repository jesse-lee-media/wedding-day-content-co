...
const Calendar = ({
  ...
  <DayPicker
    ...
    classNames={{
      ...
      nav_button: 'h-7 w-7 bg-transparent p-0 inline-flex transition items-center justify-center rounded-xs text-neutral-600 hover:text-neutral-800 hover:bg-neutral-100 focus-visible:bg-neutral-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-neutral-600/75 focus-visible:ring-offset-2 focus-visible:ring-offset-white',
