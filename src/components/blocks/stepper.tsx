      ...
      {steps.map(({ content, heading, id }, i) => (
        <Fragment key={id}>
          <h2 className="relative mt-12 mb-4 flex items-center text-3xl leading-9.5 drop-shadow-none first:mt-0 last:mb-0 xs:text-4xl">
            ...
            <span className="absolute -top-0.5 -ml-13 inline-flex size-9 items-center justify-center rounded-sm border-2 border-neutral-200/75 bg-neutral-100 font-sans text-lg font-medium ring-8 ring-neutral-50 dark:border-neutral-700 dark:bg-black dark:ring-black">
