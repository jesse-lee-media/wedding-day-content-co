    ...
    <div className="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
      {cards.map(({ image, link }, i) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 flex flex-row items-center gap-2 border-t border-black border-opacity-75 bg-white px-6 py-4 text-black transition group-hover:bg-pink-100">
